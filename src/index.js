...
const eMailInquiry = prompt('Enter your e-mail adress to continue');
const listName = prompt('Enter todolist name');
let todo = new TodoInterface(document.querySelector('body'), new List('https://todo.hillel.it'), eMailInquiry, listName);
